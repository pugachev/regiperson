...
if(!empty($_POST['womanname']))
{
    ...
    //     {
    //         // アップロードされたファイルか検査
    //         if(is_uploaded_file($_FILES["picdata"]["tmp_name"][$i]))
    //         {
    //             $tgtfilename .= $i;
    //             // $tgtfilename .= '.' . substr(strrchr($_FILES["picdata"]["tmp_name"][$i], '.'), 1);//アップロードされたファイルの拡張子を取得
    //             $tgtfilename .= '.jpg';
    //             // print_r($_FILES["picdata"]["tmp_name"]);
    //             // die();
    //             // ファイルをお好みの場所に移動
    //             print_r($tgtfilename);
    //             move_uploaded_file($_FILES["picdata"]["name"][$i], "uploads/" . $tgtfilename);
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="addImage" lang="ja" name="picdata">
